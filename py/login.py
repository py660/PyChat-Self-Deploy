if True:
    ...
    print(crayons.green("Database Loaded...")) # type: ignore
...
try:
    ...
    print(crayons.red("Recovered from crash or SGKILL. Please don't do this in the future.", bold=True)) # type: ignore
except Exception:
    pass